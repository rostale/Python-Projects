...
e2_value = StringVar()
e2 = Entry(window, textvariable=e2_value, justify='center',
           width=10, font=('Helvetica', 24))
e2.grid(row=0, column=1, padx=10, pady=(40, 20))

b1 = Button(window, text="Convert", command=from_kg,
            activebackground='green', cursor="exchange", width=20)
...
b2 = Button(window, text="Reset", command=clear_all, width=20,
            activebackground='green', cursor="exchange")
